...
<template>
    <img src="/icons/menu.svg" @click="toggleMenu" id="toggle-menu" alt="menu toggle" />
    <header id="header">
        <img src="../../assets/ck/ck_logo.png" id="logo" @click="goLanding" alt="logo" />
        <ul class="navigation">
            <li>
...
/* ----------------------------------------------
 * Generated by Animista on 2022-3-18 23:9:17
